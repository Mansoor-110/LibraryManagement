        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    qtyforborrow = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IssuedBooks_Users_User_id",
                        column: x => x.User_id,
                        principalTable: "Users",
                        principalColumn: "User_id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowRequests_User_id",
                table: "BorrowRequests",
                column: "User_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssuedBooks_borrowRequestid",
                table: "IssuedBooks",
                column: "borrowRequestid");

            migrationBuilder.CreateIndex(
                name: "IX_IssuedBooks_User_id",
                table: "IssuedBooks",
                column: "User_id");
        }
